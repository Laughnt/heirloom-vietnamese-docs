...
<figure><img src="../../.gitbook/assets/rice (1).gif" alt="Heirloom crops use custom display visuals and growth stages."><figcaption><p>Heirloom crops use custom display visuals and growth stages.</p></figcaption></figure>
